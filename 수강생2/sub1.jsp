...
<%@ include file = "top.jsp" %>    
	...
	<%
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select max(sno)+1 from student2");
			rs.next();
	...
	%>
        ...
        <form action="sub1exe.jsp" onsubmit="return ck(this)">
            <table>
                <tr> <th>학생번호</th> <td><input type="text" name="v1" readonly value="<%=newno%>"></td> </tr>
                ...
                <tr> <th>자격코드</th>
                    <td>
                        <input type="radio" name="v5" value="100" checked>정보처리기능사
                        <input type="radio" name="v5" value="200">정보처리산업기사
                        <input type="radio" name="v5" value="300">웹디자인기능사
                        <input type="radio" name="v5" value="400">컴퓨터그래픽스기능사
                    </td>
                </tr>
                <tr> <th>합격여부</th>
                    <td>
                        <input type="radio" name="v6" value="1" checked>필기
