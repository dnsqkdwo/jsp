            ...
            <tr> <th>대출번호</th> <th>고객이름</th> <th>도서이름</th> <th>대출일자</th> <th>반납일자</th> <th>대출상태</th> <th>변경</th> </tr>
            	<%
	            	try {
	            		...
	            		ResultSet rs = stmt.executeQuery("select a.lentno, a.custname, b.bookname, a.outdate, a.indate, a.status from reservation_tbl a left join bookinfo_tbl b on a.bookno=b.bookno order by a.lentno asc");
	            		while(rs.next()) {
                            ...
                            out.println("    <td><a href='update.jsp?lentno=" + rs.getString(1) + "'>변경</a></td>");
	            		}
	            		stmt.close();
	            		con.close();
	            	} catch (Exception e) {
